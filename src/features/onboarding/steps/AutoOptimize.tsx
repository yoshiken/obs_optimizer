  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">推奨設定を適用</h2>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
        <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">あなたの配信スタイル</h3>
      ...
      {!result && (
        <div className="space-y-3">
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">最適化レベルを選択</h3>
          ...
          <div className="text-center pt-2">
            <button className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-sm underline">
              あとで自分で設定する（スキップ）
            </button>
          </div>
        </div>
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 px-2"
          >
            {expanded ? '閉じる' : '詳細'}
          </button>
        </div>
      ...
      {expanded && (
        <div className="px-4 pb-4 border-t border-gray-200 dark:border-gray-600 mt-2 pt-3">
          <p className="text-xs font-medium text-gray-700 dark:text-gray-200 mb-2">この設定で適用される内容:</p>
